...
public interface AdminDbApi {
    ...
    @GET("admin/get_count_user_invoice_item.php")
    Call<ResponseBody> getCountUserInvoiceItem();

    @Headers({"Accept: application/json"})
    @GET("admin/get_list_user_not_admin.php")
    Call<ResponseBody> getUserNotAdmin();

    @Headers({"Accept: application/json"})
    @GET("admin/get_user_by_admin.php")
    Call<ResponseBody> getUserAdmin();

    @Headers({"Accept: application/json"})
    @GET("admin/get_user_not_active.php")
