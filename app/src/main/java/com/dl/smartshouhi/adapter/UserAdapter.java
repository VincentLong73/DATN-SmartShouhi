...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder>{
    ...
    public void onBindViewHolder(UserAdapter.UserViewHolder holder, int position) {
        ...
        holder.imgBtnBlock.setOnClickListener(view -> iClickListener.onClickBlockUser(userModel, position));
        holder.imgBtnUnblock.setOnClickListener(view -> iClickListener.onClickUnblock(userModel, position));
    }
